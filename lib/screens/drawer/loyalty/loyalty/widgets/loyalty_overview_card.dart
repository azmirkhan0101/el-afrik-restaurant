        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextWidget(text: "980 Point", fontSize: 18, fontWeight: FontWeight.w600,),
            ],
          ),
          Align(
            ...
            child: RichText(text: TextSpan(
              children: [
                TextSpan(text: "Expires: ", style: TextStyle(color: Colors.red,)),
                TextSpan(text: "10 Jan 2025", style: TextStyle(color: Colors.black,)),
              ]
            )),
          ),
          ...
          Align(
            alignment: Alignment.center,
            child: TextWidget(text: AppStrings.usingAvailablePoints.tr, fontSize: 16, fontColor: AppColors.grey72,),
          ),
        ],
      ),
    );

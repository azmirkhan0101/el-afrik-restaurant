...
class PromoEventsScreen extends StatelessWidget {
  const PromoEventsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppStrings.promotionsEvents.tr),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            Align(
              ...
              child: TextWidget(
                text: "${AppStrings.elAfrikWeekendSpecial.tr} - 20% OFF",
